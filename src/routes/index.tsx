...
function Index() {
  return (
    <>
      ...
      <div className="desktop:flex-row desktop:justify-between desktop:pt-48 desktop:px-0 desktop:pb-0 flex min-h-screen w-full flex-col items-center justify-evenly gap-10 px-10 pt-28 pb-16">
