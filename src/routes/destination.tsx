...
const PLANET_TEXTURES: Record<string, string> = {
  Moon: "/img/destination/texture-moon.jpg",
  Mars: "/img/destination/texture-mars.jpg",
  Europa: "/img/destination/texture-europa.jpg",
  Titan: "/img/destination/texture-titan.jpg",
};
      ...
      <div className="desktop:pt-48 flex min-h-screen flex-col pt-28">
        ...
        <div className="desktop:flex-row desktop:text-left desktop:justify-between flex flex-1 flex-col items-center gap-10 pt-10 text-center">
          <div className="flex-center tablet:items-start flex-col">
            <div className="size-fluid-planet">
              <PlanetScene
                textureUrl={assetUrl(
                  PLANET_TEXTURES[destinations[destination].name],
                )}
              />
            </div>
          </div>
